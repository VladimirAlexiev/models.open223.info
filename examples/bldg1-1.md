...
This example Building 1 model 1 is provided by current and former NIST staff and Pacific Northwest National Laboratory. See also [Building 1 model 2](https://models.open223.info/examples/bdg1-2.html) for a different modeling approach for the same building.
